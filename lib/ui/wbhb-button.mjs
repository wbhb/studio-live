    ...
    this.addEventListener('dragstart', (e) => {
      if (e instanceof DragEvent) {
        if (this.item) {
          ...
          e.dataTransfer.setData("applications/json", data);
        } else {
          console.warn('Button has no associated item');
          // const dummy = new SequencerItem();
          // e.dataTransfer.setData(SequencerItem.mediaType, dummy);
          // e.dataTransfer.setData('applications/json', JSON.stringify(dummy));
        }
