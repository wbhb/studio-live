...
GlobalScheduler.addEventListener('AudioContextChanged', (e) => {
  e.target.audioContext.audioWorklet.addModule('lib/audio/envelope-processor.mjs', {credentials: 'include'}).then((e) => {console.log(e)}).catch((e) => {console.error(e)});
});