...
export class Timings extends EventTarget {
  ...
  constructor(length, offset) {
    ...
    this.length = length || new Length(1, Length.units.beat);
    this.offset = offset || new Length(0, Length.units.beat);
...
export class SequencerItem extends Event {
  ...
  get mediaType() {
    ...
    return `application/x.wbhb.studio.${this.type.toLowerCase()}`;
  }
  
  static get mediaType() {
    return `application/x.wbhb.studio.sequenceritem`;
  }
