import {Length, ChangeEvent as LengthChangeEvent} from '../../util/length.js';
...
export class Timings extends EventTarget {
  ...
  constructor(length, offset) {
    ...
    Object.defineProperty(this, 'start', Object.getOwnPropertyDescriptor(this.constructor.prototype, 'start'));
    Object.defineProperty(this, 'length', Object.getOwnPropertyDescriptor(this.constructor.prototype, 'length'));
    Object.defineProperty(this, 'offset', Object.getOwnPropertyDescriptor(this.constructor.prototype, 'offset'));
...
Object.defineProperty(Timings, 'length', {enumerable: true, writable: true});
Object.defineProperty(Timings, 'offset', {enumerable: true, writable: true});
Object.defineProperty(Timings, 'start', {enumerable: true, writable: true});
...
export class SequencerItem extends Event {
  ...
  toJSON(key) {
    ...
    plain.timings = {};
    Object.keys(this.timings).forEach((prop) => {
      if (this.timings[prop]) {
        plain.timings[prop] = this.timings[prop].toPlain();
      }
    });
