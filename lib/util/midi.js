...
export class MIDI extends EventTarget {
  ...
  static All_Sound_Off = Symbol("All_Sound_Off");
  static Reset_All_Controllers = Symbol("Reset_All_Controllers");
  static Local_Control_Off = Symbol("Local_Control_Off");
  static Local_Control_On = Symbol("Local_Control_On");
  static All_Notes_Off = Symbol("All_Notes_Off");
  static Omni_Mode_Off = Symbol("Omni_Mode_Off");
  static Omni_Mode_On = Symbol("Omni_Mode_On");
  static Mono_Mode_On = Symbol("Mono_Mode_On");
  static Poly_Mode_On = Symbol("Poly_Mode_On");
    ...
    .then((access) => {
      ...
      for (let input of inputs) {
        ...
        input.addEventListener('midimessage', (e) => {
          ...
          const message = new MIDI.Event(this.parseMessage(e.data));
